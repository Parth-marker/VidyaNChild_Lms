...
class TeacherSearchResultsPage extends StatefulWidget {
  ...
  @override
  State<TeacherSearchResultsPage> createState() =>
      _TeacherSearchResultsPageState();
}
                ...
                child: StreamBuilder<List<Map<String, dynamic>>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final assignments = docs
                        .where((d) => d['category'] == 'assignment')
                        .toList();
                    final drafts = docs
                        .where((d) => d['category'] == 'draft')
                        .toList();
                    final uploads = docs
                        .where((d) => d['category'] == 'upload')
                        .toList();
                    ...
                    return ListView(
                      children: [
                        if (assignments.isNotEmpty) ...[
                          ...
                          ...assignments.map(
                            (d) => _ResultCard(
                              ...
                              subtitle:
                                  'Status: ${d['isPublished'] == true ? 'Published' : 'Draft'}',
                              category: 'assignment',
                              onTap: () {
                          ...
                          if (drafts.isNotEmpty || uploads.isNotEmpty)
                            const SizedBox(height: 16),
                        ],
                        if (drafts.isNotEmpty) ...[
                          ...
                          ...drafts.map(
                            (d) => _ResultCard(
                              ...
                              subtitle:
                                  '${d['lastEdited'] as String? ?? (d['isPublished'] == true ? 'Published' : 'Draft')}',
                              category: 'draft',
                              onTap: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                        ...
                        if (uploads.isNotEmpty) ...[
                          if (assignments.isEmpty && drafts.isEmpty)
